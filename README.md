...
```
* * * * * ubuntu bash /home/ubuntu/apps/portland2/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|portland2|tweet|`location`||
|portland2|facebook|`location`||
|portland2|email|`location`||
|portland2|new-comment||
|portland2|open-share-discuss||
|portland2|close-share-discuss||
|portland2|summary-copied||
|portland2|featured-tweet-action|`action`|
|portland2|featured-facebook-action|`action`|
